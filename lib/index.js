...
const mdLinks = path2 => {
  if (path.isAbsolute(path2) === false) {
    ...
    if ((0, _path.gettingFsStatObject)(absolutePath).isFile() === true) {
    ...
    } else if ((0, _path.gettingFsStatObject)(absolutePath).isDirectory() === true) {
      console.log('Es un directorio');
      const arrOfFilesOrDirsInsideADir = (0, _path.readDir)(absolutePath);
